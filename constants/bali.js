export const baliTrips = [
  {
    ...
    inclusions: [
      ...
      '11 meals - Vegetarian and non-vegetarian food options available',
  ...
  },
  {
    ...
    groupData: [
      ...
      {
        imageSrc: '/bali/17.png',
        name: 'Riya Jain',
        location: 'Chennai, Tamil Nadu',
      },
      {
        imageSrc: '/bali/18.png',
        name: 'Varun Nair',
        location: 'Kochi, Kerala',
      },
      {
        imageSrc: '/bali/19.png',
        name: 'Sanya Patel',
        location: 'Ahmedabad, Gujarat',
      },
      {
        imageSrc: '/bali/20.png',
        name: 'Rohan Singh',
        location: 'Amritsar, Punjab',
      },
      {
      ...
      {
        imageSrc: '/bali/10.png',
        name: 'Pooja Rao',
        location: 'Hyderabad, Telangana',
      },
      {
        imageSrc: '/bali/11.png',
        name: 'Swati Mishra',
        location: 'Jaipur, Rajasthan',
      },
      {
        imageSrc: '/bali/12.png',
        name: 'Nitin Joshi',
  ...
  },
  {
    ...
    groupData: [
      ...
      {
        imageSrc: '/bali/24.png',
        name: 'Anjali Thakur',
        location: 'Mumbai, Maharashtra',
      },
      {
        imageSrc: '/bali/25.png',
        name: 'Mehak Gupta',
        location: 'Delhi, India',
      },
      {
      ...
      {
        imageSrc: '/bali/27.png',
        name: 'Navi Patel',
        location: 'Chennai, Tamil Nadu',
      },
      {
        imageSrc: '/bali/28.png',
        name: 'Aditya Nair',
        location: 'Kochi, Kerala',
      },
      {
        imageSrc: '/bali/29.png',
        name: 'Sanya Patel',
        location: 'Ahmedabad, Gujarat',
      },
      {
